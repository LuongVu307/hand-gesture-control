...
from src.hand import Hand, Finger
...
@pytest.mark.parametrize("finger_type", 
                         [
                             ("thumb"),
                             ("index"),
                             ("middle"),
...
@pytest.mark.parametrize("finger_type, error_msg", 
                         [
...
@pytest.mark.parametrize("tip_y, base_y, exp_val",
                         [
                             (0.2, 0.4, "open"),
                             (0., 0., "close"),
                             (0.9, 0.3, "close"),
